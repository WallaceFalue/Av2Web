...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="../responsatividade/pcGamer.CSS">
  </head>
  <body>
    <nav>
      <h1>
    ...
    <h1 class="PCtitulo">Em breve...</h1>
<section class="PcGamerAviso">
  <article class="PCGamerNovidades">
    <h1>Intel</h1>
    <h3>
      Novos processadores Intel da 12ª até a 16ª geração<br>
      com placas-mãe de soquetes LGA 1700 e LGA 1851, garantindo compatibilidade.
    </h3>
  </article>
  ...
  <article class="PCGamerNovidades">
    <h1>AMD</h1>
    <h3>
      Processadores Ryzen 7000, 8000 e 9000<br>
      com placas-mãe de soquete AM5 totalmente suportadas.
    </h3>
  </article>
  ...
  <article class="PCGamerNovidades">
    <h1>Transporte</h1>
    <h3>
      Expansão planejada das linhas de montagem<br>
      para alcançar novas regiões do Brasil.
    </h3>
  </article>
</section>
